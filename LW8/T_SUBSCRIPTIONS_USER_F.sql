...
alter table U_DW_SUBSTRICTIONS.T_SUBSCRIPTIONS_USER_F
   add constraint FK_T_SUBSCR_USER_DIM_SUBSCR foreign key (ID_SUBSCRIPTIONS)
      references U_DW_SUBSTRICTIONS.DIM_SUBSCRIPTIONS (ID_SUBSCRIPTIONS);

alter table U_DW_SUBSTRICTIONS.T_SUBSCRIPTIONS_USER_F
   add constraint FK_T_SUBSCR_FK_T_SUBS_DIM_USER foreign key (ID_USER)
