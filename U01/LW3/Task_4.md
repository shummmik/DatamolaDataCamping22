...
Результат данного примера отображает факт того, что строки разных таблиц
 находятся в одном block. Данный подход применяют, если две таблицы имеют идентичный столбец и 
 часто приходится соединять таблицы по нему. 
 Целью такой организации является сокращение объема ввода-вывода с увеличением 
 скорости доступа при соединении связанных таблиц. Но сильно влияет на операцию insert 
 и увеличивает количество используемых блоков.