...
ALTER USER AShumilov QUOTA UNLIMITED ON ts_dw_data_01;
ALTER USER AShumilov QUOTA UNLIMITED ON ts_dw_idx_01;
ALTER USER AShumilov QUOTA UNLIMITED ON ts_persons_data_01;
ALTER USER AShumilov QUOTA UNLIMITED ON ts_persons_idx_01;
ALTER USER u_dw_references QUOTA UNLIMITED ON TS_REFERENCES_DATA_01;
GRANT UNLIMITED TABLESPACE TO u_dw_references;
ALTER USER AShumilov QUOTA UNLIMITED ON ts_references_ext_data_01;
ALTER USER AShumilov QUOTA UNLIMITED ON ts_references_idx_01;
COMMIT;
